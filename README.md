[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/DfbyInf4)
# Project 3
...
To begin, you must copy over your `Entity.Entity` and `Action` hierarchies from Project 2.
...
You should also copy over any changes you made to your non-`Entity.Entity` and non-`Action` classes, such as `World.findNearest()` and `VirtualWorld.scheduleActions()`, so that the project runs correctly.
